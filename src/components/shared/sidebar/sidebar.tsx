...
export const Sidebar = () => {
			...
			<div className="flex h-full w-full flex-col justify-between">
				...
				<div className="overflow-y-auto sm:mt-6 sm:h-[calc(100vh-13rem)] ">
					<Link href="/" passHref>
						<button
							type="button"
							className="rounded w-full text-start p-4 font-medium hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-zinc-50"
							onClick={() => isMobile && handleToggleSidebar()}
						>
							Dashboard
						</button>
	...
	return (
		<aside
			data-open={open}
			className={
				"data-[open=false]:hidden transform-gpu absolute ease-in-out z-20 h-[100dvh] w-screen border-r border-black-10 bg-white-100 px-4 py-3 dark:border-white-10 dark:bg-zinc-950 sm:relative sm:w-56"
			}
		>
			{CHILDREN}
		</aside>
