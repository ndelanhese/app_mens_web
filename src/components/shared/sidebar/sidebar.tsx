    ...
    <AnimatePresence>
      {open && (
        <Animation variant={isMobile ? 'fadeIn' : 'slideRight'}>
          <aside className="absolute z-50 h-[100svh] w-screen border-r border-black-10 bg-white-100 px-4 py-3 dark:border-white-10 dark:bg-zinc-950 sm:relative sm:w-56">
