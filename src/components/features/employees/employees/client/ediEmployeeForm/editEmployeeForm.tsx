...
const EditEmployeeFormComponent = ({
  ...
  // TODO -> corrigir dados antigos ao abrir o modal
  ...
  return (
    ...
    >
      ...
      <ControlledInput
        ...
        defaultValue={employee?.address?.[0]?.address}
      ...
      <ControlledInput
        ...
        defaultValue={employee?.address?.[0]?.number}
        placeholder="Ex. 123A"
      />
      <ControlledInput
        id="address.district"
        ...
        defaultValue={employee?.address?.[0]?.district}
      ...
      <MaskedInput
        ...
        defaultValue={employee?.address?.[0]?.postal_code}
      ...
      <ControlledSelect
        ...
        defaultValue={
          memorizedStates.find(
            state => state.key === employee?.address?.[0]?.state,
          )?.key
        }
      ...
      <ControlledSelect
        ...
        defaultValue={
          memorizedCities.find(
            city => city.key === employee?.address?.[0]?.city,
          )?.key
        }
